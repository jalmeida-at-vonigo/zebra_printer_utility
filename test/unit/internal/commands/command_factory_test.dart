...
void main() {
  ...
  test('CommandFactory creates ZPL/CPCL and generic commands', () {
    ...
    expect(CommandFactory.createSendCpclFlushBufferCommand(printer), isA<SendCpclFlushBufferCommand>());
    expect(CommandFactory.createSendClearBufferCommand(printer), isA<SendClearBufferCommand>());
    expect(CommandFactory.createSendClearErrorsCommand(printer), isA<SendClearErrorsCommand>());
    expect(CommandFactory.createSendFlushBufferCommand(printer), isA<SendFlushBufferCommand>());
